        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <DirectionProvider>
            ...
            <div className="mt-8 text-center">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-blue-100 mb-4">{t('EditFish.imagesSection')}</h2>
              ...
              <div className="mt-4">
                <label className="block text-lg font-medium text-gray-900 dark:text-blue-100 mb-2">
          ...
          <div className="flex justify-center mt-10">
            <button
              type="submit"
              className={`w-1/3 py-3 bg-blue-600 text-white rounded-lg text-lg font-semibold hover:bg-blue-700 shadow-lg transition ${
