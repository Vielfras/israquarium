...
const businessCardSchema = Joi.object().keys({
...
const updateBusinessCardSchema = Joi.object().keys({
...
const searchBusinessCardSchema = Joi.object().keys({
...
const schemas = {
  createNewBusinessCard: businessCardSchema,
  updateBusinessCard: updateBusinessCardSchema,
  searchBusinessCard: searchBusinessCardSchema,
};
